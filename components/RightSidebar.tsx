...
//                         <div className="relative z-10"><BankCard key={banks[0].$id}
//                             account={banks[0]}
//                             userName={user.name}
//                             showBalance={false}
...
//                         /> </div>
//                         {banks[1] && (
//                             <div className="absolute right-0 top-8 z-0 w-[90%] "><BankCard key={banks[1].$id}
//                                 account={banks[1]}
//                                 userName={user.name}
        ...
        <aside className="right-sidebar">
            <section className="flex flex-col pb-8">
                ...
                <div className="profile">
                    ...
                    <div className="profile-details">
                        <h1 className="profile-name">{user ? user.name : 'Guest'}</h1>

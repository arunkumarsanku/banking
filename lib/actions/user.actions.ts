...
export const exchangePublicToken = async ({
    ...
    try {
        ...
        const ProcessorTokenCreateResponse = await plaidClient.processorTokenCreate(request);
        ...
        console.error("An eroor occurred while creating exchanging token:", error)
    }
}